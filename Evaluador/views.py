    ...
    **Template:**
    ...
    def get_context_data(self, **kwargs):
        if self.request.user.is_superuser:
            ...
            context['plantillaCONGRESOESPECIAL2'] = plantillaCONGRESOESPECIAL2.objects.all().select_related('trabajo')
            ...
            context['plantillaCONGRESOESPECIAL2'] = plantillaCONGRESOESPECIAL2.objects.filter(user=self.request.user).select_related('trabajo')
...
class plantilla11_evaluacion(LoginRequiredMixin,UpdateView):
    ''' Clase UpdateView para realizar la evaluación de los TC. 
    ...
    **Template:**
    ...
    form_class = CONGRESOESPECIAL2Form
    template_name = "plantillas_evaluacion/plantilla2.html"
    success_url = reverse_lazy('misEvaluaciones')
