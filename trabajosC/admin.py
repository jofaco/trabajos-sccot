...
class trabajos_has_autoresINAdmin(admin.ModelAdmin):
    list_display=("id","trabajo","autorIN",)
...
admin.site.register(Trabajos_has_autoresIngreso,trabajos_has_autoresINAdmin)
